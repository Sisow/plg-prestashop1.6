...
<form name="sisowafterpay_form" id="sisowafterpay_form" action="{$base_dir_ssl}modules/sisow/payment.php?payment={$paymentcode}&paymentname={$paymentname}" method="post">
	<p>
	...
	<p>
		<div class="required form-group">
			<label class="" for="sisowafterpay_coc">{l s='CoC number' mod='sisowafterpay'}</label><br/>
			<input id="sisowafterpay_coc" class="is_required validate form-control" maxlength="12" title="{l s='CoC number' mod='sisowafterpay'}" name="sisowafterpay_coc"/><br/>
			<small>({l s='Only for B2B' mod='sisowafterpay'})</small>
		</div>
	</p>
