...
class SisowBillink extends PaymentModule
{
	public function __construct()
	{
		$this->paymentcode = 'billink';
		$this->name = 'sisowbillink';
		$this->paymentname = $this->l('Billink');
        ...
        $this->l('Betalen met Billink is niet mogelijk, betaal anders.');
	}
	...
	*/
	...
	public function hookPaymentReturn($params)
	{
		...
		$this->context->smarty->assign('paymentcode', $this->paymentcode);
		$this->context->smarty->assign('paymentname', "Billink");
