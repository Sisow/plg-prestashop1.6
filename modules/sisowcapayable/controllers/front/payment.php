<?php
class sisowcapayablepaymentModuleFrontController extends ModuleFrontController
{
	public $ssl = true;
	...
	public function initContent()
	{
		...
		$this->sisowcapayable = new sisowcapayable();
		
		$months = array();
		$months['01'] = $this->sisowcapayable->l('January');
		$months['02'] = $this->sisowcapayable->l('February');
		$months['03'] = $this->sisowcapayable->l('March');
		$months['04'] = $this->sisowcapayable->l('April');
		$months['05'] = $this->sisowcapayable->l('May');
		$months['06'] = $this->sisowcapayable->l('June');
		$months['07'] = $this->sisowcapayable->l('July');
		$months['08'] = $this->sisowcapayable->l('August');
		$months['09'] = $this->sisowcapayable->l('September');
		$months['10'] = $this->sisowcapayable->l('October');
		$months['11'] = $this->sisowcapayable->l('November');
		$months['12'] = $this->sisowcapayable->l('December');
